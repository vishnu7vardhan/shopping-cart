						...
						<div class="wrap-col">
							<div class="register">
								<div id="register_form">
									...
									<form:form name="userDetails" id="details" method="post" action="userDetails">
            
									
										<label class="row">
											<div class="col-1-2">
												<div class="wrap-col">
													<form:input type="text" path="username" name="username" id="username" placeholder="Enter username" required="required" />
												</div>
											</div>
											<div class="col-1-2">
												<div class="wrap-col">
													<form:input type="password" path="password" name="password" id="password" placeholder="Enter password" required="required" />
												</div>
											</div>
											
											<div class="col-1-2">
												<div class="wrap-col">
													<form:input type="text" path="userFullName" name="fullname" id="name" placeholder="Enter userfullname" required="required" />
												</div>
											</div><div class="col-1-2">
												<div class="wrap-col">
													<input type="text" path="userEmail" name="mail" id="email" placeholder="Enter email" required="required" />
												</div>
											</div><div class="col-1-2">
												<div class="wrap-col">
													<form:input type="text" path="userPhone" name="number" id="phn num" placeholder="Enter password" required="required" />
												</div>
											</div>
										</label>
