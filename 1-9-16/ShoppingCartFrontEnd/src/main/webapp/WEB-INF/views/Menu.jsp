				...
				<div class="row">
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Pasta Plates</h3>
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/15.jpg"/>"></img></a>
								<div class="wrapper">
							...
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/10.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								   <span>$25 - $26</span>
								</div>
							...
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/9.jpg"/>"></img</a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								  <span>$25 - $26</span>
								</div>
					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Starters</h3>
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/14.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								   <span>$25 - $26</span>
								</div>
							...
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/8.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								  <span>$25 - $26</span>
								</div>
							...
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/7.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								  <span>$25 - $26</span>
								</div>
					...
					<div class="col-1-3">
						<div class="wrap-col">
							<h3>Salads</h3>
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/13.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								  <span>$25 - $26</span>
								</div>
							...
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/4.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								  <span>$25 - $26</span>
								</div>
							...
							<div class="post">
								<a href="#"><img src="<c:url value="/resources/images/5.jpg"/>"></img></a>
								<div class="wrapper">
								  <h5><a href="#">Lorem ipsum dolor</a></h5>
								  <span>$25 - $26</span>
								</div>
